...
@section('content')
    <div class="container-fluid">
        <div class="coming-soon swiper mySwiper h-screen">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="{{ URL::asset('build/images/bg-1.jpg') }}" alt="">
                    <div class="bg-overlay bg-violet-500/60 inset-0 absolute"></div>
                </div>
                <div class="swiper-slide">
            ...
            <div class="grid grid-cols-12 justify-center">
                <div class="col-span-8 col-start-3">
                    <div class="text-center mb-5">
                        <a href="{{ url('index') }}">
                            <img src="{{ URL::asset('build/images/logo-sm.svg') }}" alt="" class="h-7 mx-auto inline-block"><span
                                class="text-22 align-middle ml-2 font-semibold text-white">Minia</span>
                        </a>
                    </div>
                    <div class="text-center">
                        <h2 class="mt-8 text-white">Let's get started with Minia</h2>
                    ...
                    <div class="mt-4">
                        <div class="p-5">
                            <div id="countdown">
                                <div class="text-center flex justify-center gap-8">
                                    <div class=" w-[25%]">
