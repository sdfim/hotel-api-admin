                            ...
                            <div class="my-auto">
                                <div>
                                    <div
                                        ...
                                        <i class="bx bx-mail-send text-3xl leading-[2.2] text-mandarin-500"></i>
                                    </div>
                                </div>
                                ...
                                <div class="mt-5">
                                    <a href="{{ url('auth-login') }}"
                                       class="btn border-transparent bg-mandarin-500 w-full py-2.5 text-white shadow-md shadow-mandarin-200 dark:shadow-zinc-600">Back
                                        to Home</a>
                                </div>
                            </div>
