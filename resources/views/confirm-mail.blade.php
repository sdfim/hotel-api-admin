                    ...
                    <div class="w-full bg-white xl:p-12 p-10">
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div>
                                    <div
                                        class=" bg-gray-500/10 h-16 w-16 text-primary text-center mx-auto rounded-full">
                                        <i class="bx bx-mail-send text-3xl leading-[2.2] text-maintheme-500"></i>
                                    </div>
                                </div>

                                <div class="text-center mt-6">
                                    <h4 class="text-gray-600 text-21">Success !</h4>
                                    <p class="text-gray-500 mt-1">At vero eos et accusamus et iusto odio dignissimos
                                        ducimus
                                ...
                                <div class="mt-5">
                                    <a href="{{ url('auth-login') }}"
                                       class="btn border-transparent bg-maintheme-500 w-full py-2.5 text-white shadow-md shadow-maintheme-200 dark:shadow-zinc-600">Back
                                        to Home</a>
                                </div>
                            </div>
