                ...
                <div class="card-body">
                    <div class="flex flex-wrap items-center mb-2">
                        ...
                        <div class="ltr:ml-auto rtl:mr-auto flex gap-1">
                            ...
                            <button type="button"
                                class="btn py-1 px-2 text-13 bg-violet-50/50 border-transparent text-violet-500 hover:bg-violet-500 hover:text-white focus:bg-violet-500 focus:text-white dark:bg-violet-500/20 dark:text-violet-300 dark:hover:bg-violet-500 dark:hover:text-white font-medium">1M</button>
                            <button type="button"
                        ...
                        <div class="tab-pane block" id="buy-tab" role="tabpanel">
                            ...
                            <div>
                                <div class="form-group mb-3">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-zinc-100">Payment method
                                        :</label>
                                    <select
