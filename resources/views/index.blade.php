                ...
                <div class="card-body">
                    <div class="flex flex-wrap items-center mb-2">
                        ...
                        <div class="ltr:ml-auto rtl:mr-auto flex gap-1">
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-gray-50/50 border-transparent text-gray-500 hover:bg-gray-50/50 dark:hover:bg-zinc-600/800 hover:text-white focus:bg-gray-500 focus:text-white dark:bg-gray-500/10 dark:text-zinc-100 hover:bg-gray-500 dark:hover:bg-gray-200 dark:hover:text-gray-800 font-medium">
                                ALL
                            </button>
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-maintheme-50/50 border-transparent text-maintheme-500 hover:bg-maintheme-500 hover:text-white focus:bg-maintheme-500 focus:text-white dark:bg-maintheme-500/20 dark:text-maintheme-300 dark:hover:bg-maintheme-500 dark:hover:text-white font-medium">
                                1M
                            </button>
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-gray-50/50 border-transparent text-gray-500 hover:bg-gray-50/50 dark:hover:bg-zinc-600/800 hover:text-white focus:bg-gray-500 focus:text-white dark:bg-gray-500/10 dark:text-zinc-100 hover:bg-gray-500 dark:hover:bg-gray-200 dark:hover:text-gray-800 font-medium">
                            ...
                            <div class="mt-4 mt-sm-0">
                                <div>
                                    ...
                                    <h6 class="text-gray-800 dark:text-gray-100">0.4412 BTC =
                                        <span
                                            class="text-gray-700 dark:text-zinc-100 text-14 font-normal">$ 4025.32</span>
                                    </h6>
                                </div>
                                <div class="mt-4 pt-2">
                                    <p class="mb-2 dark:text-zinc-100">
                                        <i class="mdi mdi-circle align-middle text-10 mr-2 text-maintheme-500 "></i>
                                        Ethereum
                                    </p>
                                    <h6 class="text-gray-800 dark:text-gray-100">4.5701 ETH =
                                        <span
                                            class="text-gray-700 dark:text-zinc-100 text-14 font-normal">$ 1123.64</span>
                                    </h6>
                                </div>
                                <div class="mt-4 pt-2">
                                    <p class="mb-2 dark:text-zinc-100">
                                    ...
                                    <h6 class="text-gray-800 dark:text-gray-100">35.3811 LTC =
                                        <span
                                            class="text-gray-700 dark:text-zinc-100 text-14 font-normal">$ 2263.09</span>
                                    </h6>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-span-12 xl:col-span-7">
            <div class="grid grid-cols-12 gap-5">
                        ...
                        <div class="card-body">
                            <div class="flex flex-wrap items-center mb-2">
                                ...
                                <div class="ltr:ml-auto rtl:mr-auto">
                                    <select
                                        class="form-select form-select-sm py-0 ltr:pl-4 rtl:pr-4 border-gray-50 bg-gray-50/20 dark:border-zinc-600 dark:text-gray-100 dark:bg-zinc-700">
                            ...
                            <div class="grid grid-cols-12 gap-5">
                                ...
                                <div class="col-span-6">
                                    <div class="mt-4 mt-sm-0">
                                        ...
                                        <div class="mt-3">
                                            <a href="#"
                                               class="btn py-1.5 px-2.5 text-xs bg-maintheme-500 text-white shadow-md shadow-maintheme-100 border-transparent hover:bg-maintheme-700 focus:bg-maintheme-700 focus:ring focus:ring-maintheme-50/50 dark:shadow-zinc-600">View
                                                more
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div
                        class="card card-h-100 bg-maintheme-500 border-transparent shadow shadow-maintheme-100 dark:shadow-zinc-800 relative overflow-hidden">
            ...
            <div class="card dark:bg-zinc-800 dark:border-zinc-600 card-h-100">
                <div class="card-body pb-0">
                    <div class="flex flex-wrap items-center mb-2">
                        ...
                        <div class="ltr:ml-auto rtl:mr-auto flex gap-1">
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-maintheme-50/50 border-transparent text-maintheme-500 hover:bg-maintheme-500 hover:text-white focus:bg-maintheme-500 focus:text-white dark:bg-maintheme-500/20 dark:text-maintheme-200 dark:hover:bg-maintheme-500 dark:hover:text-white">
                                ALL
                            </button>
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-gray-50/50 border-transparent text-gray-500 hover:bg-gray-500 dark:hover:bg-zinc-600/800 hover:text-white focus:bg-gray-500 focus:text-white dark:bg-gray-500/10 dark:text-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">
                                1M
                            </button>
                            <button type="button"
                                    class="btn py-1 px-2 text-13 bg-gray-50/50 border-transparent text-gray-500 hover:bg-gray-500 dark:hover:bg-zinc-600/800 hover:text-white focus:bg-gray-500 focus:text-white dark:bg-gray-500/10 dark:text-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">
                    ...
                    <div class="grid grid-cols-12 gap-10 items-center">
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <div class="p-4 space-y-5">
                                ...
                                <div class="mt-4 pt-2">
                                    <a href=""
                                       class="btn bg-maintheme-500 w-full border-transparent text-white font-medium shadow-md shadow-maintheme-100 hover:bg-maintheme-700 focus:bg-maintheme-700 focus:ring focus:ring-maintheme-50/50 dark:shadow-zinc-600">See
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600 w-full card-h-100">
                <div class="card-body flex flex-wrap items-center pb-0">
                    ...
                    <div class="ltr:ml-auto rtl:mr-auto">
                        <div class="dropdown">
                            <a class="btn p-0 border-0 dropdown-toggle cursor-pointer" id="dropdownMenuButton1"
                            ...
                            rounded-lg shadow-lg hidden bg-clip-padding border-none"
                                ...
                                <li>
                                    <a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 dark:text-zinc-100 hover:bg-gray-50/50 dark:hover:bg-zinc-600/80/50"
                                       href="#">Action</a>
                                </li>
                ...
                <div class="card-body">
                    ...
                    <div class="px-2 py-2">
                        ...
                        <div class="bg-gray-50 rounded-full mt-2 dark:bg-zinc-700" style="height: 6px;">
                            <div
                                class="bg-maintheme-500 progress-bar-striped h-[6px] ltr:rounded-l rtl:rounded-r overflow-hidden"
                        ...
                        <div class="tab-pane block" id="buy-tab" role="tabpanel">
                            <div class="ltr:float-right rtl:float-left ms-2">
                                <h5 class="text-sm text-gray-700 dark:text-zinc-100"><i
                                        class="bx bx-wallet text-maintheme-500 text-16 align-middle mr-1"></i> <a
                            ...
                            <div>
                                <div class="form-group mb-3">
                                    <label class="block mb-2 font-medium text-gray-700 dark:text-zinc-100">Payment
                                        method
                                        :</label>
                                    <select
                                        class="w-full border-gray-100 rounded rtl:pr-3 selection:text-10 py-1.5 focus:border-maintheme-100 focus:ring focus:ring-maintheme-50/50 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100 dark:focus:ring-gray-500/10">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div
                                        ...
                                        <select
                                            class="border-0 ltr:pl-1.5 rtl:pr-1.5 focus:border-maintheme-100 focus:ring focus:ring-maintheme-50/60 focus:z-40 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-100 dark:focus:ring-gray-500/10"
                                        ...
                                        <input type="text"
                                               class=" border-0 w-full py-1.5 focus:border-maintheme-100 focus:ring focus:ring-maintheme-50/60 focus:z-40 dark:bg-zinc-700 dark:placeholder:text-gray-200 dark:focus:ring-gray-500/10"
                                    ...
                                    <div
                                        ...
                                        <input type="text"
                                               class="w-full  py-1.5 border-0 focus:border-maintheme-100 focus:ring focus:ring-maintheme-50/60 focus:z-40 dark:bg-zinc-700 dark:placeholder:text-gray-200 dark:focus:ring-gray-500/10 dark:text-gray-100"
                                               placeholder="$58,245">
                                        <label
                                ...
                                <div class="text-center">
                                    <button type="button"
                                            class="btn bg-green-500 px-6 border-transparent text-white shadow-md shadow-green-100 hover:bg-green-600 focus:bg-green-600 focus:ring focus:ring-green-50 dark:shadow-zinc-600">
                                        Buy
                                        Coin
                                    </button>
                                </div>
                            ...
                            <div>
                                <div class="form-group mb-3">
                                    <label class="block text-gray-700 dark:text-zinc-100 font-medium mb-2">Wallet ID
                                        :</label>
                                    <input type="email"
                                           class="w-full placeholder:text-sm py-1.5 border-gray-100 rounded  dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder:text-gray-200 dark:text-gray-100 focus:ring focus:ring-maintheme-50/60 dark:focus:ring-gray-500/10 focus:ring-offset-0"
                                ...
                                <div class="text-center">
                                    <button type="button"
                                            class="btn bg-red-500 px-6 border-transparent text-white shadow-md shadow-red-100 hover:bg-red-600 focus:bg-red-600 focus:ring focus:ring-red-50 dark:shadow-zinc-600">
                                        Sell
                                        Coin
                                    </button>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">14 Mar, 2021
                                                </p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="p-3">
                                            <div class="text-end">
                                                <h5 class="text-sm mb-0 text-gray-700 dark:text-gray-100">0.016 BTC
                                                </h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">15 Mar, 2021
                                                </p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">16 Mar, 2021
                                                </p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">17 Mar, 2021
                                                </p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                ...
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">18 Mar, 2021
                                                </p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="p-3">
                                            <div class="text-end">
                                                <h5 class="text-sm mb-0 text-gray-700 dark:text-gray-100">0.018 BTC
                                                </h5>
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">Coin Value</p>
                                            </div>
                                        </td>
                            ...
                            <div class="px-3" data-simplebar style="max-height: 352px;">
                                <table class="table w-full">
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3">
                                            <div>
                                                <h5 class="text-sm mb-1  text-gray-700 dark:text-gray-100">Sell BTC
                                                </h5>
                                                <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">16 Mar, 2021
                                                </p>
                                            </div>
                ...
                <div class="px-3" data-simplebar style="max-height: 352px;">
                    <ul class="overflow-hidden">
                        <li class="flex pl-12 pb-6 relative">
                            ...
                            <div>
                                <div class="flex">
                                    <div class="grow mr-4 ml-2 overflow-hidden w-72">
                                        <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">24/05/2021,
                                            18:24:56</h5>
                                        <p
                                    ...
                                    <div class="shrink-0 text-end">
                                        <div class="dropdown relative">
                                            ...
                                            rounded-lg shadow-lg hidden bg-clip-padding border-none"
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 dark:text-gray-100 hover:bg-gray-50/50 dark:hover:bg-zinc-600/80"
                                                       href="#">Action</a>
                                                </li>
                                                <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap
                            ...
                            <div
                                class="after:contant-[] after:absolute after:h-20 after:border-l-2 after:border-dashed after:border-gray-100 after:left-5 after:z-0 dark:after:border-zinc-600">
                            </div>
                        </li>

                        <li class="flex pl-12 pb-6 relative">
                            <div class="absolute left-0 z-40">
                                <div class="h-10 w-10 bg-maintheme-50 rounded-full text-center">
                                    <i class="mdi mdi-ethereum text-2xl leading-relaxed text-maintheme-500"></i>
                                </div>
                            </div>
                            <div>
                                <div class="flex">
                        ...
                        <li class="flex pl-12 pb-6 relative">
                            <div class="absolute left-0 z-40">
                                <div class="h-10 w-10 bg-maintheme-50 rounded-full text-center">
                                    <i class="mdi mdi-litecoin text-2xl leading-relaxed text-maintheme-500"></i>
                                </div>
                            </div>
                            <div>
                                <div class="flex">
                        ...
                        <li class="flex pl-12 relative">
                            <div class="absolute left-0">
                                <div class="h-10 w-10 bg-maintheme-500 rounded-full text-center"></div>
                            </div>
                            <div>
                                <div class="flex">
                                    <div class="grow mr-4 ml-2 overflow-hidden w-72">
                                        <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">24/05/2021,
                                            18:24:56</h5>
                                        <p class="text-13 overflow-hidden text-ellipsis whitespace-nowrap text-gray-500">
                                            0xb77ad0099e21d4fca87fa4ca92dda1a40af9e05d205e53f38bf026196fa2e431</p>
                                    </div>
                                    <div class="shrink-0 text-end mr-1 w-20">
