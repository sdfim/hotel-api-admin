        ...
        <div class="topbar-brand flex items-center">
            <div
                ...
                <a href="#" class="flex items-center font-bold text-lg  dark:text-white">
                    ...
                    <span class="hidden xl:block align-middle">UJV</span>
                </a>
            </div>
            <button type="button"
            ...
            <form class="app-search hidden xl:block px-5">
                <div class="relative inline-block">
                    <input type="text"
                        ...
                        placeholder="Search...">
                    <button
                        class="py-1.5 px-2.5 text-white bg-violet-500 inline-block absolute ltr:right-1 top-1 rounded shadow shadow-violet-100 dark:shadow-gray-900 rtl:left-1 rtl:right-auto leading-8"
