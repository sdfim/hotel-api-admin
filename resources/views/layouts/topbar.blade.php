    ...
    <div class="topbar-brand flex items-center">
        <div class="navbar-brand flex h-[50px] shrink items-center justify-between border-r bg-slate-50 px-5 dark:border-zinc-700 dark:bg-zinc-800">
            <a href="#" class="flex items-center font-bold text-lg dark:text-white">
                <img src="{{ URL::asset('build/images/logo-vidanta.png') }}" alt="logo" class="logo-lg inline-block h-6 ltr:mr-2 rtl:ml-2 mt-1" />
                <img src="{{ URL::asset('build/images/logo-vidanta-short.png') }}" alt="logo" class="logo-sm inline-block h-6 ltr:mr-2 rtl:ml-2 mt-1" style="display: none;" />
            </a>
        </div>
        <button type="button" id="vertical-menu-btn"
            class="vertical-menu-btn h-[50px] ltr:-ml-10 ltr:mr-6 rtl:-mr-10 rtl:ml-10 text-gray-100 dark:text-white">
            ...
            <div id="user-dropdown" x-show="open" x-transition
                ...
                <div class="flex justify-between gap-2">
                    <a href="{{ route('profile.show') }}"
                        class="flex flex-1 items-center space-x-2 rounded px-2 py-1 hover:bg-gray-100 dark:hover:bg-zinc-700">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="flex w-full items-center space-x-2 rounded px-2 py-1 hover:bg-gray-100 dark:hover:bg-zinc-700">
