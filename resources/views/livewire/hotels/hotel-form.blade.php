...
@endphp
<div>
    @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('external-user'))
        ...
        @if ($record->exists)
            <div class="hotel-form-toggle-container">
                ...
                <div class="right-block">
                    <span class="text-sm">Activity Log Info</span>
                    ...
                    @can('delete', \Modules\HotelContentRepository\Models\Product::class)
        ...
        @if($showModalLogInfoProduct)
            <div x-data="{ showModal: @entangle('showModalLogInfoProduct') }" x-show="showModal" @click.away="showModal = false"
                class="hotel-modal" style="overflow-y: auto; max-height: 100vh;">
