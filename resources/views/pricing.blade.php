                                        ...
                                        <div class="p-2">
                                            ...
                                            <div class="mt-4 pt-2 text-muted">
                                                <p class="mb-4 text-15 text-gray-500 dark:text-zinc-100/60"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Verifide
                                                    work and
                                                    reviews</p>
                                                <p class="mb-4 text-15 text-gray-500 dark:text-zinc-100/60"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Dedicated
                                                    Ac managers</p>
                                                <p class="mb-4 text-15 text-gray-500 dark:text-zinc-100/60"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Unlimited
                                                    proposals</p>
                                                <p class="mb-4 text-15 text-gray-500 dark:text-zinc-100/60"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Project
                                                    tracking
                                                </p>
                                                <p class="mb-4 text-15 text-gray-500 dark:text-zinc-100/60"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Dedicated
                                ...
                                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                                    <div class="card-body bg-violet-500 overflow-hidden rounded">
                                        <div class="p-2 relative">
                                            <div
                                                class="w-48 text-center p-1 text-violet-500 font-medium bg-white ltr:rotate-45 rtl:-rotate-45 absolute ltr:-right-20 rtl:-left-20 top-0">
                                                <span>Featured</span>
                                            </div>
                                            ...
                                            <p class="text-white/50  mt-3 text-15 ">For small teams trying out UJV for
                                                ...
                                                period of time</p>
                                            <div class="mt-4 pt-2 text-muted">
                                                <p class="mb-4 text-15 text-white"><i
                                                        class="mdi mdi-check-circle text-secondary text-18 ltr:mr-2 rtl:ml-2 align-middle"></i>Verifide
                                                    work and
                                                    reviews</p>
                                                <p class="mb-4 text-15 text-white"><i
