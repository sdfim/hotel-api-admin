                        ...
                        <div class="col-span-12">
                            <div class="text-center">
                                <h1 class="text-8xl text-gray-600 mb-3 dark:text-gray-100">4<span
                                        class="text-maintheme-500 mx-2">0</span>4</h1>
                                <h4 class="uppercase mb-2 text-gray-600 text-[21px] dark:text-gray-100">Sorry, page not
                                    found
                                </h4>
                            </div>
                            <div class="mt-12 text-center">
                                <a class="btn bg-maintheme-500 border-transparent focus:ring focus:ring-maintheme-50 py-2 text-white"
