                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                ...
                                <div class="text-center mt-6">
                                    ...
                                    <p class="text-gray-500 mt-1 dark:text-zinc-100/60">We have sent you verification
                                        email
                                ...
                                <div class="mt-5 text-center">
                                    <a href="{{ url('auth-login') }}"
                                       class="btn border-transparent bg-maintheme-500 py-2.5 text-white shadow-md shadow-maintheme-200 dark:shadow-zinc-600">Verify
                                        email</a>
                                </div>
