                    ...
                    <form action="{{ route('pricing_rules.store') }}" method="POST"
                        ...
                        <div class="col-span-12 lg:col-span-6">
                            ...
                            <div class="mb-4">
                                ...
                                <x-input id="property" name="property" value="{{ old('property') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <x-input id="travel_date" name="travel_date"
                                         value="{{ old('travel_date', now()->format('Y-m-d\TH:i')) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <x-select id="supplier_id" class="block mt-1 w-full" name="supplier_id"
