<button type="button" onClick="openModal('{{ $getRecord()->search_id }}','request')"
        ...
        data-tw-target="#modal-idlargemodal-{{ $getRecord()->id }}-request">
        <i class="mdi mdi-information-outline text-white"></i>
</button>
            ...
            <div
                ...
                <div class="bg-white dark:bg-zinc-700">
                    ...
                    <div class="modal-body">
                        <span
                            class="text-slate-900 dark:text-white mt-5 text-sm font-medium tracking-tight">Request:</span>
                        <pre
                            class="text-slate-900 dark:text-white mt-5 text-sm font-medium tracking-tight">{{json_encode(json_decode($getRecord()->request), JSON_PRETTY_PRINT) }}</pre>
                    </div>
                    <!-- Modal footer -->
                    <div
                        ...
                        <button type="button"
                                ...
                                onClick="closeModal('{{ $getRecord()->search_id }}','request')">Cancel
                        </button>
                    </div>
                </div>
            </div>
