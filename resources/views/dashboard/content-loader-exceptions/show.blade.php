    ...
    <div class="col-span-12 xl:col-span-6">
        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
            <div class="card-body pb-0 flex">
                ...
                <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100 ml-4">Report exception</h6>
            </div>
            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <div class="bg-white dark:bg-zinc-700">
                                        ...
                                        <div class="p-6 space-y-6 ltr:text-left rtl:text-right">
                                            <pre
                                                style="font-size: 0.8em;">{{json_encode(json_decode($report->request), JSON_PRETTY_PRINT) }}</pre>
                                        </div>
                                        <!-- Modal footer -->
                                        <div
                    ...
                    <div class="mt-5 tab-content">
                        <div class="block tab-pane" id="tab-pills-response">
                            <p class="mb-0 dark:text-gray-300">
                                @php
                                    $file_response = Storage::get($report->response_path);
                                    if($file_response == ''){
