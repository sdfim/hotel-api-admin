@if($getRecord()->status === 'error')
    <button type="button" onClick="openModalError('{{ $getRecord()->id }}','request')"
            ...
            @endphp
            data-tw-target="#modal-idmodal-{{ $getRecord()->id }}-request">{{ $side }}    </button>
@endif
<div class="relative z-50 hidden modal" id="modal-idmodal-{{ $getRecord()->id }}-request"
            ...
            <div
                ...
                <div class="bg-white dark:bg-zinc-700">
                    <div class="flex items-center p-4 border-b rounded-t border-gray-50 dark:border-zinc-600">
                        ...
                        <button onClick="closeModalError('{{ $getRecord()->id }}','request')"
                    ...
                    <div
                        ...
                        <button type="button"
                                ...
                                onClick="closeModalError('{{ $getRecord()->id }}','request')">Cancel
                        </button>
                    </div>
                </div>
            </div>
