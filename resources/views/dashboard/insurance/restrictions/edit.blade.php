                ...
                <div class="relative overflow-x-auto">
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            <div class="mb-6">
                                <x-button-back route="{{ route('insurance-restrictions.index') }}" text="Back"/>
                            </div>
                        </div>
                    </div>
                    <div class="ml-1 mr-1 col-span-9 xl:col-span-6" style="min-height: 460px">
                        @livewire('insurance.restrictions.edit-restriction-form', compact('insuranceRestriction'))
                    </div>
                </div>
            </div>
        </div>
