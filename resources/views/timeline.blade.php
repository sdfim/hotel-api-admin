                        ...
                        <div class="col-span-12 xl:col-span-10 xl:col-start-2 ">
                            <div class="reltive ">
                                ...
                                <div class="relative pt-16">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-1 md:col-span-6">
                                            <div class="ltr:text-right rtl:text-left relative mt-9">
                                                <i
                                                    class="bx bx-briefcase-alt-2 text-violet-500 text-2xl md:text-3xl ltr:mr-10 rtl:ml-10 md:mr-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 hidden md:block ltr:md:-right-2 rtl:md:-left-2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-11 md:col-span-6">
                                            <div
                                                ...
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rotate-45 border-l border-b border-gray-50 rounded-sm bg-white top-7 -left-2 dark:bg-zinc-800 dark:border-zinc-600 ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        class="after:content-[''] absolute border-l border-violet-500 h-full top-0 left-10 md:left-[50%]">
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-11 md:col-span-6 order-2 md:order-1">
                                            <div
                                                ...
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rotate-45 border-r border-t border-gray-50 rounded-sm bg-white top-7 -right-2 md:block hidden dark:bg-zinc-800 dark:border-zinc-600">
                                                </div>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rotate-45 border-l border-b border-gray-50 rounded-sm bg-white top-7 -left-2 block md:hidden dark:bg-zinc-800 dark:border-zinc-600">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-1 md:col-span-6 order-1 md:order-2">
                                            <div class="relative mt-9">
                                                <i
                                                    class="bx bx-user-pin text-violet-500 text-2xl md:text-3xl ltr:mr-10 rtl:ml-10 ltr:md:ml-5 rtl:md:mr-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 ltr:-left-2 rtl:-right-2 hidden md:block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="relative">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-1 md:col-span-6">
                                            <div class="ltr:text-right rtl:text-left relative mt-9">
                                                <i
                                                    class="bx bx-bar-chart-square text-violet-500 text-2xl md:text-3xl ltr:mr-10 rtl:ml-10 md:mr-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 hidden md:block ltr:md:-right-2 rtl:md:-left-2 md:mr-5">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-11 md:col-span-6">
                                ...
                                <div class="relative">
                                    <div class="grid grid-cols-12">
                                        ...
                                        <div class="col-span-1 md:col-span-6 order-1 md:order-2">
                                            <div class="relative mt-9">
                                                <i
                                                    class="bx bx-camera text-violet-500 text-2xl md:text-3xl mr-10 md:ml-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 ltr:-left-2 rtl:-right-2 hidden md:block ">
                                                </div>
                                            </div>
                                ...
                                <div class="relative">
                                    <div class="grid grid-cols-12">
                                        <div class="col-span-1 md:col-span-6">
                                            <div class="ltr:text-right rtl:text-left relative mt-9">
                                                <i
                                                    class="bx bx-pie-chart-alt text-violet-500 text-2xl md:text-3xl ltr:mr-10 rtl:ml-10 md:mr-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 hidden md:block ltr:md:-right-2 rtl:md:-left-2">
                                                </div>
                                            </div>
                                ...
                                <div class="relative pb-16">
                                    <div class="grid grid-cols-12">
                                        ...
                                        <div class="col-span-1 md:col-span-6 order-1 md:order-2">
                                            <div class="relative mt-9">
                                                <i
                                                    class="bx bx-home-alt text-violet-500 text-2xl md:text-3xl mr-10 md:ml-5"></i>
                                                <div
                                                    class="after:content-[''] absolute h-4 w-4 rounded-full bg-violet-500 top-2 ltr:-left-2 rtl:-right-2 hidden md:block ">
                                                </div>
                                            </div>
                                ...
                                <div class="relative text-center">
                                    <div
                                        ...
                                        <div
                                            class="after:content-[''] absolute h-4 w-4 rotate-45 -translate-x-2 border-l border-t border-gray-50 rounded-sm bg-white -top-2 left-10 md:left-[50%] dark:bg-zinc-800 dark:border-zinc-600">
                                        </div>
                                    </div>
                                </div>
                            </div>
