                ...
                <div class="card-body mb-6">
                    <div class="grid grid-cols-1 lg:grid-cols-12">
                        <div class="col-span-12 lg:col-span-4 lg:col-start-5">
                            <div class="text-center">
                                ...
                                <div class="mt-4">
                                    <button type="button"
                                            class="btn border-transparent bg-maintheme-500 mt-2 mr-2 shadow-md text-white shadow-maintheme-200 focus:ring focus:ring-maintheme-50 dark:shadow-zinc-600">
                                        Email
                                        Us
                                    </button>
                                    <button type="button"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            <div class="relative">
                                <i
                                    class="bx bx-help-circle text-7xl text-maintheme-50/50 absolute ltr:-right-3 rtl:-left-3 -top-4 dark:text-maintheme-500/10"></i>
                            </div>
                            <div class="p-5">
                                <h5 class="text-maintheme-500">01.</h5>
                        ...
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            ...
                            <div class="p-5">
                                <h5 class="text-maintheme-500">02.</h5>
                        ...
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            ...
                            <div class="p-5">
                                <h5 class="text-maintheme-500">03.</h5>
                        ...
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            ...
                            <div class="p-5">
                                <h5 class="text-maintheme-500">04.</h5>
                        ...
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            ...
                            <div class="p-5">
                                <h5 class="text-maintheme-500">05.</h5>
                                <h5 class="mt-3 text-gray-700 dark:text-gray-100">Where can I get some?</h5>
                        ...
                        <div class="border border-gray-50 rounded-md overflow-hidden dark:border-zinc-600">
                            ...
                            <div class="p-5">
                                <h5 class="text-maintheme-500">06.</h5>
                                <h5 class="mt-3 text-gray-700 dark:text-gray-100">What is Lorem Ipsum?</h5>
