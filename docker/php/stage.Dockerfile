...
# Install headers and libraries for sockets extension
RUN apk add --no-cache linux-headers musl-dev && \
    docker-php-ext-install sockets

# Install Imagick with WebP support
RUN apk add --no-cache imagemagick imagemagick-dev libwebp libwebp-dev \
