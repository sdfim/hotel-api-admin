...
class TravelAgencyCommissionControllerTest extends TestCase
{
    ...
    public function test_index()
    {
        ...
        $response->assertJsonStructure([
            'data' => [
                '*' => ['id', 'commission_value', 'commission_value_type', 'date_range_start', 'date_range_end']
            ],
            'message'
        ]);
    ...
    public function test_store()
    {
        ...
        $response->assertJsonStructure([
            'data' => ['name', 'commission_value', 'commission_value_type', 'date_range_start', 'date_range_end'],
            'message'
        ]);
    ...
    public function test_show()
    {
        ...
        $response->assertStatus(200);
        $response->assertJsonStructure([
            'data' => ['id', 'commission_value', 'commission_value_type', 'date_range_start', 'date_range_end'],
            'message'
        ]);
