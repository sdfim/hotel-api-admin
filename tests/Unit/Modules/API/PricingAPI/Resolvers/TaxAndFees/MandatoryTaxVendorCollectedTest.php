 ...
 *
 * This class tests all combinations of mandatory taxes where taxes are collected by the vendor.
 *
 * Coverage includes:
...
class MandatoryTaxVendorCollectedTest extends BaseTaxAndFeeResolverTest
{
    ...
    public function test_edit_tax_vendor_collection(): void
    {
        $baseNetRate = 125;
        $transformedRates = $this->createBaseTransformedRates($baseNetRate, 7);
    ...
    public function test_update_tax_vendor_collection(): void
    {
        $baseNetRate = 125;
        $transformedRates = $this->createBaseTransformedRates($baseNetRate, 7);
