...
class PricingRulesToolsTest extends TestCase
{
    use RefreshDatabaseMany;

    protected array $connectionsToTransact = ['mysql', 'mysql_cache'];

    protected PricingRulesTools $pricingRulesTools;
    ...
    protected array $supplierRequestGiataIds;
    ...
    public function test_rules_returns_empty_array_for_standalone_package()
    {
    ...
    public function test_rules_handles_channel_conditions()
    {
        ...
        $this->assertEquals($notEqualRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($matchingRule->id, $result[1]['id']); // Weight 10
    }

    public function test_rules_handles_property_conditions()
    {
        $giataId = $this->supplierRequestGiataIds[0]; // 45422295
        $secondGiataId = $this->supplierRequestGiataIds[1]; // 38711975
        ...
        $this->assertEquals($notEqualRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($lessThanRule->id, $result[1]['id']); // Weight 12
        $this->assertEquals($matchingRule->id, $result[2]['id']); // Weight 10
    }

    public function test_rules_handles_destination_conditions()
    {
        $query = array_merge($this->baseQuery, [
            'destination' => '961',
        ]);
        ...
        $this->assertCount(3, $result);
        $this->assertEquals($notEqualRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($greaterThanRule->id, $result[1]['id']); // Weight 12
        $this->assertEquals($matchingRule->id, $result[2]['id']); // Weight 10
    }

    public function test_rules_handles_travel_date_conditions()
    {
        $checkIn = '2025-07-15';
        ...
        // Should return 3 matching rules, ordered by weight desc
        $this->assertCount(3, $result);
        $this->assertEquals($gteRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($ltRule->id, $result[1]['id']); // Weight 12
        $this->assertEquals($matchingRule->id, $result[2]['id']); // Weight 10
    }

    public function test_rules_handles_date_of_stay_conditions()
    {
        $checkIn = '2025-07-15';
        $checkOut = '2025-07-20';
        ...
        $this->assertCount(3, $result);
        $this->assertEquals($betweenRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($equalsRule->id, $result[1]['id']); // Weight 12
        $this->assertEquals($gteRule->id, $result[2]['id']); // Weight 10
    }

    public function test_rules_handles_booking_date_conditions()
    {
        ...
        // Should return 3 matching rules, ordered by weight desc
        $this->assertCount(2, $result);
        $this->assertEquals($gteRule->id, $result[0]['id']); // Weight 12
        $this->assertEquals($ltRule->id, $result[1]['id']); // Weight 10
    }

    public function test_rules_handles_total_guests_conditions()
    {
        ...
        // Should return 3 matching rules, ordered by weight desc
        $this->assertCount(2, $result);
        $this->assertEquals($equalsRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($lteRule->id, $result[1]['id']); // Weight 12
    }

    public function test_rules_handles_days_until_departure_conditions()
    {
        ...
        $this->assertCount(3, $result);
        $this->assertEquals($equalsRule->id, $result[0]['id']); // Weight 15
        $this->assertEquals($gteRule->id, $result[1]['id']); // Weight 12
        $this->assertEquals($ltRule->id, $result[2]['id']); // Weight 10
    }

    public function test_rules_handles_nights_conditions()
    {
        ...
        $this->assertEquals($matchingRule->id, $result[0]['id']);
    }

    public function test_rules_handles_rating_conditions()
    {
    ...
    public function test_rules_handles_number_of_rooms_conditions()
    {
    ...
    public function test_rules_handles_multiple_conditions()
    {
    ...
    public function test_rules_ordered_by_weight()
    {
        ...
        $this->assertEquals($rule1->id, $result[0]['id']);
        $this->assertEquals($rule2->id, $result[1]['id']);
        $this->assertEquals($rule3->id, $result[2]['id']);
    }

    public function test_rules_with_exclude_parameter()
    {
        ...
        $this->assertCount(1, $normalResults);
        $this->assertEquals($normalRule->id, $normalResults[0]['id']);
        ...
        $this->assertCount(1, $excludeResults);
        $this->assertEquals($excludeRule->id, $excludeResults[0]['id']);
    }
}
