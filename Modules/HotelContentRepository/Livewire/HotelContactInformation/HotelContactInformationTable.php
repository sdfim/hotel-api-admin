...
namespace Modules\HotelContentRepository\Livewire\HotelContactInformation;
...
class HotelContactInformationTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(
                HotelContactInformation::with('contactInformations')->where('hotel_id', $this->hotelId)
            )
            ->columns([
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->action(function ($data) {
                        ...
                        $hotelContactInformation = HotelContactInformation::create($data);
    ...
    {
        return view('livewire.hotels.hotel-contact-information-table');
    }
}
