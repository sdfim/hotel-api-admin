...
class ContentApiRoutes
{
    ...
    {
        Route::middleware('auth:sanctum')->prefix('content')->name('api.content.')->group(function () {
        ...
        Route::middleware('auth:sanctum')->prefix('v1/content')->name('api.v1.content.')->group(function () {
