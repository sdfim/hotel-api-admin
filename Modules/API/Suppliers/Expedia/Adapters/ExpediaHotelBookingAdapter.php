...
use Modules\API\Suppliers\Expedia\Transformers\ExpediaHotelBookingRetrieveBookingTransformer;
use Modules\API\Suppliers\Expedia\Transformers\ExpediaHotelBookTransformer;
...
class ExpediaHotelBookingAdapter extends BaseHotelBookingAdapter implements HotelBookingSupplierInterface
{
    ...
    public function availabilityChange(array $filters, SupplierNameEnum $supplier, $type = 'change'): ?array
    {
        ...
        $this->addItem($filters, 'change', ['Test' => 'hard_change']);
