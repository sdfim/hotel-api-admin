...
class DestinationRequest extends ApiRequest
{
    ...
    {
        return [
            'hotel' => 'required_without_all:city,country,giata,q|string|min:3',
            'city' => 'required_without_all:hotel,country,giata,q|string|min:3',
            'country' => 'required_without_all:hotel,city,giata,q|string|min:3',
            'giata' => 'required_without_all:hotel,city,country,q|string|min:3',
            'q' => 'required_without_all:hotel,city,country,giata|string|min:3',
