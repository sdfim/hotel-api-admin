...
class ClearSearchCacheByBookingItemsTools {
    ...
    public function clear(array $bookingItems): void
    {
        ...
        Log::debug('ClearSearchCacheByBookingItemsTools | $arr_pricing_search : ' . json_encode($arr_pricing_search));
        ...
        try {
            ...
            foreach ($bookingItems as $bookingItem) {
                ...
                foreach ($room_ids as $room_id) {
                    ...
                    Log::debug('ClearSearchCacheByBookingItemsTools | $search_ids_data : ' . json_encode($search_ids_data));
        ...
        Log::info('ClearSearchCacheByBookingItemsTools | Execution time of clear() in seconds: ' . $execution_time);
    }
}
